...
public class SkeletonMobile : MonoBehaviour
{
    public enum AIState
    {
        Patrol,
    ...
    SkeletonController m_EnemyController;
    ...
    void Start()
    {
        m_EnemyController = GetComponent<SkeletonController>();
        DebugUtility.HandleErrorIfNullGetComponent<SkeletonController, SkeletonMobile>(m_EnemyController, this, gameObject);
        ...
        DebugUtility.HandleErrorIfNullGetComponent<AudioSource, SkeletonMobile>(m_AudioSource, this, gameObject);
