...
/* 
    ...
    SkeletonManager m_EnemyManager;
    ...
    void Start()
    {
        m_EnemyManager = FindObjectOfType<SkeletonManager>();
        DebugUtility.HandleErrorIfNullFindObject<SkeletonManager, SkeletonController>(m_EnemyManager, this);
        ...
        DebugUtility.HandleErrorIfNoComponentFound<DetectionModule, SkeletonController>(detectionModules.Length, this, gameObject);
        DebugUtility.HandleWarningIfDuplicateObjects<DetectionModule, SkeletonController>(detectionModules.Length, this, gameObject);
    ...
    void FindAndInitializeAllWeapons()
    {
        ...
        if (m_Weapons == null)
        {
            ...
            DebugUtility.HandleErrorIfNoComponentFound<WeaponController, SkeletonController>(m_Weapons.Length, this, gameObject);
    ...
    public WeaponController GetCurrentWeapon()
    {
        ...
        DebugUtility.HandleErrorIfNullGetComponent<WeaponController, SkeletonController>(m_CurrentWeapon, this, gameObject);
